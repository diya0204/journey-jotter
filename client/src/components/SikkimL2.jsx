...
const LuxurySikkimDay2 = ({ destination, onBack, onNext, onImageClick }) => {
  ...
  const activities = [
    ...
    {
      name: "Nathu La Pass",
      image: "https://www.sikkimtourismindia.com/uploads/nathula-pass.jpg",
      link: "NathulaPass",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Day 2 - Tsomgo Lake, Baba Mandir & Nathula Pass
        </h2>
...
export default LuxurySikkimDay2;
